...
public class AuthenticationConstants {
    ...
    public static final String FRONTEND_REDIRECT_AFTER_LOGIN_URL = System.getenv("FRONTEND_REDIRECT_AFTER_LOGIN_URL");
    private static final String JWT_SECRET_KEY_PLAIN = System.getenv("JWT_SECRET_KEY_PLAIN");
